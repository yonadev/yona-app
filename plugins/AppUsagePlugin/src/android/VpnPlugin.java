...
public class VpnPlugin extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        if (action.equals(ACTION_START_VPN)) {
            ...
            String vpnConfig = args.optString(0);
            String vpnLoginId = args.optString(1);
            String vpnPassword = args.optString(2);
            startVPN(vpnConfig, vpnLoginId, vpnPassword, callbackContext);
            return true;
    ...
    private void startVPN(String vpnConfig, String vpnLoginID, String vpnPassword, CallbackContext callbackContext) {
        ...
        try {
            ...
            vp.mName = "OpenVPN";
            vp.mUsername = vpnLoginID;
            vp.mPassword = vpnPassword;
