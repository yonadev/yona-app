 ...
 */
UserPreferences.prototype.getBoolean = createGetter(
  isBoolean,
  identity,
  "getBoolean"
);
 ...
 * Invoked with `(err)`.
 */
UserPreferences.prototype.putBoolean = createSetter(isBoolean, "putBoolean");
 ...
 */
UserPreferences.prototype.getNumber = createGetter(
  isNumber,
  function(value) {
 ...
 * Invoked with `(err)`.
 */
UserPreferences.prototype.putNumber = createSetter(isNumber, "putNumber");
 ...
 */
UserPreferences.prototype.getString = createGetter(
  isString,
  identity,
  "getString"
);
 ...
 * Invoked with `(err)`.
 */
UserPreferences.prototype.putString = createSetter(isString, "putString");
 ...
 */
UserPreferences.prototype.get = function(
  key,
  aDefaultValue,
  aSuccessCallback,
  aErrorCallback
  ...
  if (!isString(key)) {
    errorCallback(
      new TypeError("Missing or invalid argument, 'key'. String expected.")
    );
    return;
  }
 ...
 * Invoked with `(err)`.
 */
UserPreferences.prototype.put = function(
  key,
  aValue,
  aSuccessCallback,
  aErrorCallback
 ...
 * Invoked with `(err)`.
 */
UserPreferences.prototype.del = function(
  key,
  aSuccessCallback,
  aErrorCallback
) {
 ...
 * Invoked with `(err)`.
 */
UserPreferences.prototype.has = function(
  key,
  successCallback,
  aErrorCallback
) {
 ...
 * Invoked with `(err)`.
 */
UserPreferences.prototype.keys = function(successCallback, aErrorCallback) {
  var errorCallback = aErrorCallback || noop;
 ...
 * Invoked with `(err)`.
 */
UserPreferences.prototype.clear = function(successCallback, aErrorCallback) {
  var errorCallback = aErrorCallback || noop;
...
exports.getInstance = function(aName) {
  ...
  if (!registry[name]) {
    registry[name] = new UserPreferences(name);
  }
