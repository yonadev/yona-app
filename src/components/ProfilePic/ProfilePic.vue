<template>
    <div>
        ...
        <svg width="100%" height="35px" viewBox="0 0 50 50" v-else-if="pic_data">
              <circle cx="25" cy="25" r="25" :fill="(pic_data.type === 'buddy' ? '#6c2a58' : '#1d71b8')"/>
              <text dominant-baseline="middle" text-anchor="middle" font-size="15" fill="white" x="25" y="26">{{pic_data.text}}</text>
        </svg>
    </div>
</template>
