<template>
  <div class="control has-icons-right">
    <div class="input-floating-label" :class="{'is-focused': isFocused || isFilled, 'is-disabled': disabled, 'has-error': errors.has(id)}">
      <input :id="id"
             :name="id"
             :title="name"
             :disabled="disabled"
    ...
    <span v-if="errors.has(id)" class="input-error">{{ errors.first(id) }}</span>
  </div>
</template>
