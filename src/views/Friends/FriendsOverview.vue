<template>
  <div id="friends-overview">
    ...
    <div v-for="(buddy, index) in buddies" :key="'requested'+index" :class="{'grey-bg-div': buddy && buddy.receivingStatus === userStatus.Requested}">
      <div v-if="buddy && buddy.receivingStatus === userStatus.Requested" class="columns is-mobile">
        <div class="column is-2">
          <div class="img-wrapper">
