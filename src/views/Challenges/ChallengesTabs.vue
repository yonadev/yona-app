          ...
          >
            <a>
              <div class="tabImage">
                <img
                  :src="
                    require('../../assets/images/challenges/icn_challenge_timebucket.svg')
                  "
                />
                <div
                  class="counter"
                  v-if="goalsByType('BudgetGoal').length > 0"
                >
                  {{ goalsByType("BudgetGoal").length }}
                </div>
              </div>
              <div class="tabTitle">
                {{ $t("challengescredit") }}
          ...
          >
            <a>
              <div class="tabImage">
                <img
                  :src="
                    require('../../assets/images/challenges/icn_challenge_timezone.svg')
                  "
                />
                <div
                  class="counter"
                  v-if="goalsByType('TimeZoneGoal').length > 0"
                >
                  {{ goalsByType("TimeZoneGoal").length }}
                </div>
              </div>
              <div class="tabTitle">
                {{ $t("challengeszone") }}
          ...
          >
            <a>
              <div class="tabImage">
                <img
                  :src="
                    require('../../assets/images/challenges/icn_challenge_nogo.svg')
                  "
                />
                <div class="counter" v-if="goalsByType('NoGoGoal').length > 0">
                  {{ goalsByType("NoGoGoal").length }}
                </div>
              </div>
              <div class="tabTitle">
                {{ $t("challengesnogo") }}
